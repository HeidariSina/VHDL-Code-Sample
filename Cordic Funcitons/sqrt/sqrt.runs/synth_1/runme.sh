...
HD_PWD='C:/Users/Sinah/Desktop/HW4/sqrt/sqrt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CORDIC_Hyperbolic_vectoringmode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CORDIC_Hyperbolic_vectoringmode.tcl
