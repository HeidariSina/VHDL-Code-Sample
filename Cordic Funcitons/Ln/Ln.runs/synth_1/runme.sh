...
HD_PWD='C:/Users/Sinah/Desktop/HW4/Ln/Ln.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CORDIC_hyperbolic_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CORDIC_hyperbolic_tb.tcl
